                    ...
                    <div class="row">
                                ...
                                <select name="employer" class="form-control @error('employer') is-invalid @enderror">
                                    ...
                                    @foreach ($employers as $employer)
                                        <option value="{{ $employer->id }}"
                                            ...
                                            {{ $employer->employer_profile != null ? ' | ' . $employer->employer_profile->company_name : '' }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="job_category"
                                    ...
                                    @foreach ($job_categories as $job_category)
                                        <option value="{{ $job_category->id }}"
                                            {{ $job->category_id == $job_category->id ? 'selected' : '' }}>
                                            {{ $job_category->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="education_level"
                                    ...
                                    @foreach ($education_levels as $level)
                                        <option value="{{ $level->id }}"
                                            {{ $job->education_level_id == $level->id ? 'selected' : '' }}>
                                            {{ $level->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="career_level"
                                    ...
                                    @foreach ($career_levels as $career_level)
                                        <option value="{{ $career_level->id }}"
                                            {{ $job->career_level_id == $career_level->id ? 'selected' : '' }}>
                                            {{ $career_level->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <textarea name="job_description" class="form-control @error('job_description') is-invalid @enderror ">{{ $job->job_description }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <textarea name="job_excerpt" class="form-control @error('job_excerpt') is-invalid @enderror ">{{ $job->job_excerpt }}</textarea>
                                @error('job_excerpt')
                                    <span role="alert" class="invalid-feedback">( {{ $message }} )</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div>
                                ...
                                <textarea name="job_requirements" class="form-control @error('job_requirements') is-invalid @enderror ">{{ $job->job_requirements }}</textarea>
                                        ...
                                        <div class="repeater mb-3">
                                            <div class="row m-0">
                                                ...
                                                <div class="col-md-3 col-4 text-end">
                                                    <button type="button"
                                                        class="btn bg-gradient-success btn-sm m-0 add_new_file"><i class="fas fa-plus text-white"></i></button>
                                                        <button type="button"
                                                        class="btn bg-gradient-danger btn-sm m-0 remove-repeater-row"><i class="fas fa-trash text-white"></i></button>
                                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <select class="multiple-select w-100 input-text @error('job_skills') is-invalid @enderror" data-placeholder="Select" name="job_skills[]" multiple="multiple">
                                    @foreach ($skills as $skill)
                                        <option
                                            {{ $job_skills != null ? (in_array($skill->id, $job_skills) ? 'selected' : '') : '' }}
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                <label class="text-dark"><strong>External Link " Optional if exists Apply button will replaced"</strong></label>
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                <label class="text-dark"><strong>E-Mail " Optional if exists Apply button will replaced"</strong></label>
