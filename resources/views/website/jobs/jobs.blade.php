                        ...
                        <form method="GET" class="informeson" action="{{ route('website.jobs') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input class="country-field" name="country[]" value="{{ $country->id }}"
                                            type="checkbox" autocomplete="off" {{ in_array($country->id,
                                        request('country', [])) ? 'checked' : '' }}>
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                    </label>
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-country"
                                    id="country-options" onclick="changeText(this.id)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input class="city-field" name="city[]" value="{{ $city->id }}" type="checkbox"
                                            autocomplete="off" {{ in_array($city->id, request('city', [])) ? 'checked' :
                                        '' }}>
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                    ...
                                    <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                        <label
                                            ...
                                            <input class="city-field" name="city[]" value="{{ $city->id }}"
                                                type="checkbox" autocomplete="off" {{ in_array($city->id,
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-city"
                                    id="city-options" onclick="changeText(this.id)">
                                    <i class="fa fa-plus-circle"></i> Show more
                                </a>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input class="area-field" name="area[]" value="{{ $area->id }}" type="checkbox"
                                            autocomplete="off" {{ in_array($area->id, request('area', [])) ? 'checked' :
                                        '' }}>
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                    ...
                                    <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                        <label
                                            ...
                                            <input class="area-field" name="area[]" value="{{ $area->id }}"
                                                type="checkbox" autocomplete="off" {{ in_array($area->id,
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-area"
                                    id="area-options" onclick="changeText(this.id)">
                                    <i class="fa fa-plus-circle"></i> Show more
                                </a>
                            </div>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label class="btn button-theme radio-btn inline-checkbox">
                                        <input class="all-career_levels-field" name="" value="" type="checkbox"
                                            autocomplete="off">
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-career_level"
                                    id="career_level-options" onclick="changeText(this.id)">
                                    <i class="fa fa-plus-circle"></i> Show more
                                </a>
                            </div>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label class="btn button-theme radio-btn inline-checkbox">
                                        <input class="all-job_categories-field" name="" value="" type="checkbox"
                                            autocomplete="off">
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-job_category"
                                    id="job_category-options" onclick="changeText(this.id)">
                                    <i class="fa fa-plus-circle"></i> Show more
                                </a>
                            </div>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label class="btn button-theme radio-btn inline-checkbox">
                                        <input class="all-job_types-field" name="" value="" type="checkbox"
                                            autocomplete="off">
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input class="job_type-field" name="job_type[]" value="{{ $job_type->id }}"
                                            type="checkbox" autocomplete="off" {{ in_array($job_type->id,
                                ...
                                <a class="show-more-options" data-toggle="collapse" data-target="#options-job_type"
                                    id="job_type-options" onclick="changeText(this.id)">
                                    <i class="fa fa-plus-circle"></i> Show more
                                </a>
                            </div>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input name="date_posted[]" value="past_week" {{ in_array('past_week',
                                            request('date_posted', [])) ? 'checked' : '' }} type="checkbox"
                                            autocomplete="off">
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                                        </p>
                                ...
                                <div class="btn-group-toggle mb-2" data-toggle="buttons">
                                    <label
                                        ...
                                        <input name="date_posted[]" value="past_month" {{ in_array('past_month',
                                            request('date_posted', [])) ? 'checked' : '' }} type="checkbox"
                                            autocomplete="off">
                                        <p class="m-0">
                                            <i class="fa fa-check fa-lg check-icon" aria-hidden="true"></i>
                ...
                <div class="pagination-box hidden-mb-45 text-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            @else
                            <li class="page-item"><a class="page-link" href="{{ $jobs->previousPageUrl() }}">Prev</a>
                            </li>
                            @endif
                            ...
                            @for ($i = 1; $i <= $jobs->lastPage(); $i++)
                                ...
                                <li class="page-item {{ $jobs->currentPage() == $i ? 'active' : '' }}"><a
                                        class="page-link" href="{{ url()->current() }}?{{ $url }}">{{ $i }}</a>
                                </li>
                                @endfor
...
<script>
    $(document).ready(function() {
        ...
        function changeText(option){
            if($("#" + option).text()=="Show less"){
                $("#" + option).text("Show more");
            }
            else{
                $("#" + option).text("Show less");
            }
        }
