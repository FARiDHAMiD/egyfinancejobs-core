                    ...
                    <div class="row">
                                ...
                                <select name="job_category"
                                    ...
                                    @foreach ($job_categories as $job_category)
                                        <option value="{{ $job_category->id }}"
                                            {{ old('job_category') == $job_category->id ? 'selected' : '' }}>
                                            {{ $job_category->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <textarea name="job_description" class="form-control @error('job_description') is-invalid @enderror ">{{ old('job_description') }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <textarea name="job_excerpt" class="form-control @error('job_excerpt') is-invalid @enderror ">{{ old('job_excerpt') }}</textarea>
                                @error('job_excerpt')
                                    <span role="alert" class="invalid-feedback">( {{ $message }} )</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            <div>
                                ...
                                <textarea name="job_requirements" class="form-control @error('job_requirements') is-invalid @enderror ">{{ old('job_requirements') }}</textarea>
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="col-md-9 col-8 col-12">
                                                <div class="form-group m-sm-0 mb-2">
                                                    <input type="text" data-name="question"
                            ...
                            <div>
                                ...
                                <select class="multiple-select w-100 input-text @error('job_skills') is-invalid @enderror" data-placeholder="Select" name="job_skills[]" multiple="multiple">
                                    @foreach ($skills as $skill)
                                        <option
                                            {{ old('job_skills') != null ? (in_array($skill->id, old('job_skills')) ? 'selected' : '') : '' }}
