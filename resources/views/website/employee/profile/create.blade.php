                        ...
                        <div class="details text-left">
                            ...
                            <form id="userAccountSetupForm" enctype="multipart/form-data" method="post"
                                                ...
                                                @foreach ($career_levels as $career_level)
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2 px-2">
                                                        <label
                                                            ...
                                                            <input
                                                                {{ old('career_level_id') == $career_level->id ? 'checked' : '' }}
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2 px-2">
                                                        <label
                                                            ...
                                                            <input type="checkbox" name="open_job_type_ids[]"
                                                                value="{{ $job_type->id }}"
                                                                {{ old('open_job_type_ids') != null ? (in_array($job_type->id, old('open_job_type_ids')) ? 'checked' : '') : '' }}
                                                                autocomplete="off">
                                                            <p class="m-0">
                                                                {{ $job_type->name }}
                                            ...
                                            <div class="form-group">
                                                <select class="w-100 input-text" name="job_title_id">
                                                    ...
                                                    @foreach ($job_titles as $job_title)
                                                        <option
                                                        {{ old('job_title_id') != null ? ( $job_title->id == old('job_title_id') ? 'selected' : '') : '' }}
                                            ...
                                            <div class="form-group">
                                                <select class="multiple-select w-100 input-text" data-placeholder="Select"
                                                    ...
                                                    @foreach ($job_categories as $job_category)
                                                        <option
                                                            {{ old('job_category_ids') != null ? (in_array($job_category->id, old('job_category_ids')) ? 'selected' : '') : '' }}
                                ...
                                <section id="step-2" class="form-step d-none">
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-12">
                                            <div class="row datedrop-box">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <input value="{{ old('birthdate') }}" placeholder="Day"
                                                            type="date" name="birthdate" class="input-text">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                    ...
                                    <div class="mt-3 d-flex justify-content-between flex-md-row flex-column">
                                        <button class="btn button-theme btn-navigate-form-step mb-md-0 mb-3"
                                            type="button" step_number="1">Previous Step</button>
                                        <button class="btn button-theme btn-navigate-form-step" type="button"
                                ...
                                <section id="step-3" class="form-step d-none">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input
                                                                ...
                                                                placeholder="Day" type="date"
                                                                name="experience[ending_in]" id="ending_in-0" class="input-text">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" name="education[degree_details]"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text" name="education[education_level_id]"
                                                            ...
                                                            @foreach ($education_levels as $education_level)
                                                                <option
                                                                    {{ old('education') != null && array_key_exists('education_level_id', old('education')) ? (old('education')['education_level_id'] == $education_level->id ? 'selected' : '') : '' }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text" name="education[university_id]"
                                                            ...
                                                            @foreach ($universities as $university)
                                                                <option
                                                                    {{ old('education') != null && array_key_exists('university_id', old('education')) ? (old('education')['university_id'] == $university->id ? 'selected' : '') : '' }}
                                                                    value="{{ $university->id }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="education[grade]" class="input-text">
                                                            ...
                                                            <option {{ old('education') != null ? (old('education')['grade'] == 'Fair' ? 'selected' : '') : '' }} value="Fair">Fair</option>
                                                            <option {{ old('education') != null ? (old('education')['grade'] == 'Good' ? 'selected' : '') : '' }} value="Good">Good</option>
                                                            <option {{ old('education') != null ? (old('education')['grade'] == 'Very Good' ? 'selected' : '') : '' }} value="Very Good">Very Good</option>
                                                            <option {{ old('education') != null ? (old('education')['grade'] == 'Excellent' ? 'selected' : '') : '' }} value="Excellent">Excellent</option>
                                                            <option {{ old('education') != null ? (old('education')['grade'] == 'Very good with honors' ? 'selected' : '') : '' }} value="Very good with honors">Very good with honors</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input
                                                            value="{{ old('education') != null ? old('education')['certificate_title'] : '' }}"
                                                            type="text" name="education[certificate_title]"
                                                            class="input-text" placeholder="CMA , CPA , CFA , etc">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input
                                                            type="file" name="education[certificate_image]"
                                                            class="input-text" >
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mt-3 d-flex justify-content-between flex-md-row flex-column">
                                        <button class="btn button-theme btn-navigate-form-step mb-md-0 mb-3"
                                            type="button" step_number="2">Previous Step</button>
