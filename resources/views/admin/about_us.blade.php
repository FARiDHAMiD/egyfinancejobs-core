                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="facebook" value="{{$aboutSection['facebook']}}"
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="text-dark"><strong>twitter</strong></label>
                                <input type="text" name="twitter" value="{{$aboutSection['twitter']}}"
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('about_company') is-invalid @enderror " rows="10" cols="5" name="about_company">{{$aboutSection['about_company']}}</textarea>
