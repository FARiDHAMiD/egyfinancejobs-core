                ...
                <form class="search-form">
                    <div class="row">
                        <div class="col-md-8 col-8">
                            <input type="text" placeholder="Search for course by title" name="search" class="mr-5"
                                style="padding: 11px;">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-course">
                    ...
                    <div class="course-body">
                        ...
                        <h4 class="c-title"><a href="{{route('courses.show', 1)}}">Financial Literacy for Beginners</a>
                        </h4>
