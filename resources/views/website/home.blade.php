                    ...
                    @foreach ($latest_companies as $employer)
                        <div class="slick-slide-item">
                            <a href="{{ route('employer.profile', $employer->id) }}">
                                <img  style="height: 120px;object-fit: cover" src="{{ empty($employer->getFirstMedia('company_logo')) ? asset('/website/img/company-logo.png') : $employer->getFirstMedia('company_logo')->getUrl() }}" alt="brand" class="img-fluid">
                            </a>
                        </div>
                    @endforeach
                ...
                @foreach ($latest_jobs as $job)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="categorie-box home-latest-jobs">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span class="job-date-posted"> <i class="flaticon-time"></i> {{ $job->created_at->diffForHumans() }} </span>

                                </div>
                                <div class="col-6 text-right">

                                    <span class="job-date-posted text-end"> <i class="fa fa-map-marker"></i> {{ $job->city->name }} </span>
                                </div>
                            </div>
                ...
                @foreach ($jobs_cairo as $job_cairo)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="categorie-box home-latest-jobs">
                            ...
                            <span class="job-date-posted"> <i class="flaticon-time"></i> {{ $job_cairo->created_at->diffForHumans() }} </span>
                        </div>
                    </div>
                @endforeach
