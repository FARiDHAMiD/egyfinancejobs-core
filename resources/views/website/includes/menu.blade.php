                            ...
                            <li>
                                <div class="btn-group dropleft user-menu-quick-links">
                                    <a type="button" class="dropdown-toggle" data-toggle="dropdown"
                                        aria-expanded="false">
                                        <img src="{{ empty(auth()->user()->getFirstMedia('employee_profile')) ? asset('/website/img/avatar.png') : auth()->user()->getFirstMedia('employee_profile')->getUrl() }}" alt="avatar">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="d-flex align-items-center px-3 pt-2">
                                            <div>
                                                <div class="user-image-circle">
                                                    <img src="{{ empty(auth()->user()->getFirstMedia('employee_profile')) ? asset('/website/img/avatar.png') : auth()->user()->getFirstMedia('employee_profile')->getUrl() }}" alt="">
                                                </div>
                                            </div>
                                            <div class="pl-3">
                                        ...
                                        <a class="dropdown-item" href="{{route('employee.jobs.applications')}}">Applications</a>
                                        <a class="dropdown-item" href="{{route('employee.profile.general-info.edit')}}">Edit profile</a>
                                        ...
                                        <div class="dropdown-wr no-arrow noti-drop">
                                            <button class="btn dropdown-toggle" type="button" data-toggle="dropdown"
                                                aria-expanded="false">
                                                <span class="noti-num">{{ auth()->user()->unreadnotifications()->count()}}</span>
                                                <span class="i-wr">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{(str_contains($item->data['url'], '?'))? $item->data['url'].'&notify='.$item->id : $item->data['url'].'?notify='.$item->id}}">
                                                    <img src="/bell.svg"
                                                        alt="">
