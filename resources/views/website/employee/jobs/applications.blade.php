                        ...
                        <div data-application-index="{{ $index }}"
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="company-logo">
                                    <img src="{{ empty($application->job->employer->getFirstMedia('company_logo')) ? asset('/website/img/company-logo.png') : $application->job->employer->getFirstMedia('company_logo')->getUrl() }}" alt="logo">
                                </div>
                            ...
                            <div class="description">
                                <div class="float-left">
                                    <h5 class="title"><a
                                            href="{{ route('website.job-details', $application->job->id) }}">{{ $application->job->job_title }}</a>
                                    </h5>
                                    <div class="candidate-listing-footer">
                                        <ul>
                                                <li><i class="flaticon-work"></i> {{optional($application->job->employer_profile)->company_name??'N/A' }}


                                            <li><i class="flaticon-pin"></i> {{ empty($application->job->area) ? null : $application->job->area->name }},
                                                {{ empty($application->city) ? null : $application->job->city->name }}, {{ $application->job->country->name }}
                                            </li>
                                        </ul>
                            ...
                            <div class="candidate-listing-footer">
                                <ul>
                                    ...
                                    <li><i class="flaticon-pin"></i>
                                        {{ empty($applications[$application_index]->job->area) ? null : $applications[$application_index]->job->area->name }},
                                        {{ empty($applications[$application_index]->job->city) ? null : $applications[$application_index]->job->city->name }},
