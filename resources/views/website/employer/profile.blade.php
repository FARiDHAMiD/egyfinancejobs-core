...
@section('website.content')
 ...
 <div class="job-listing-section content-area job-details employer-details">
    ...
    <div class="employer-header">
        <img style="object-fit: cover" height="200px" src="{{ empty($employer->getFirstMedia('company_banner')) ? asset('/website/img/banner_img.jpg') : $employer->getFirstMedia('company_banner')->getUrl() }}" class="employer-banner w-100" alt="">

        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-4">
                    <div class="employer-logo">
                        <img src="{{ empty($employer->getFirstMedia('company_logo')) ? asset('/website/img/company-logo.png') : $employer->getFirstMedia('company_logo')->getUrl() }}" class="employer-banner" alt="">
                    </div>
                </div>
                <div class="col-lg-9 col-sm-8 mt-4">
                    ...
                    <div class="employer-links">
                        @if (!empty($social_links->website)) <a href="{{$social_links->website}}" target="_blank" class="website">{{$social_links->website}}</a> @endif
                        <ul class="social-media">
                            @if (!empty($social_links->facebook)) <li><a class="facebook-bg" href="{{$social_links->facebook}}"><i class="fa fa-facebook"></i></a></li> @endif
                            @if (!empty($social_links->twitter)) <li><a class="twitter-bg" href="{{$social_links->linkedin}}"><i class="fa fa-linkedin"></i></a></li> @endif
                            @if (!empty($social_links->linkedin)) <li><a class="linkedin-bg" href="{{$social_links->twitter}}"><i class="fa fa-twitter"></i></a></li> @endif
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- share profile -->
                                    <!-- Modal -->
                                    <div class="modal fade" id="share-buttons-{{ $employer_profile->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="share-buttons-{{ $employer_profile->id }}Title"
                                        aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <div class="text-center share-buttons">
                                                        ...
                                                        <ul class="social-list clearfix">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('employer.profile', $employer_profile->employer_id) }}" class="copyLink" >
