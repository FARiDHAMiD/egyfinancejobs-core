...
<div class="container-fluid">
    <form enctype="multipart/form-data" action="{{ route('employers.update', $employer->id) }}" class="mb-5"
        method="post">
        @method('put')
        @csrf
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select type="text" name="company_size"
                                ...
                                <option {{ $employer_profile->company_size == '1-10' ? 'selected' : '' }}
                                    value="1-10">1-10</option>
                                <option {{ $employer_profile->company_size == '11-100' ? 'selected' : '' }}
                                    value="11-100">11-100</option>
                                <option {{ $employer_profile->company_size == '101-1000' ? 'selected' : '' }}
                                    value="101-1000">101-1000</option>
                                <option {{ $employer_profile->company_size == '1000+' ? 'selected' : '' }}
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" {{ old('featured')==1 ||
                                $employer_profile->featured ? 'checked'
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <select type="text" name="company_industry"
                                ...
                                <option {{ $employer_profile->company_industry_id == $industry->id ? 'selected' : '' }}
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="company_description"
                                class="form-control @error('company_description') is-invalid @enderror ">{{$employer_profile->company_description}}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select type="text" name="country"
                                ...
                                <option {{ $employer_profile->country_id == $country->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select type="text" name="area"
                                ...
                                <option {{ (empty($employer_profile->area) ? null : $employer_profile->area_id) ==
                                    $area->id ? 'selected' : '' }}
                                    value="{{ $area->id }}"
