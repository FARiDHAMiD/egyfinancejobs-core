...
<body>
    ...
    @if (session()->has('alert_message'))
        <div class="modal fade" id="alert-message-modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    @if ($errors->any())
        <!-- errors Modal -->
        <div class="modal fade show" id="errors-modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="errors-modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
