            ...
            <div class="row">
                        ...
                        <div class="description">
                            ...
                            <div>
                                ...
                                <div class="candidate-listing-footer">
                                    <ul>
                                        <li><i class="flaticon-work"></i> {{ optional($job->employer_profile)->company_name??'N/A' }}</li>
                            ...
                            <div class="div-right text-right">
                                ...
                                <a href="{{$job->external_email}}" class="btn button-success bg-success text-white  copyLink" >
                                       Copy  E-Mail
                                    </a>
                                ...
                                @if (Auth::check())
                                    @if (is_has_job(auth()->user()->id, $job->id))
                                        <a href="{{ route('employee.jobs.unsave-job', $job->id) }}" class="btn button-theme">
                                            Unsave
                                        </a>
                                    @else
                                            ...
                                            <form class="modal-body text-center py-5" method="post"
                                                ...
                                                <div class="text-left">
                                                    @foreach ($job->questions as $question)
                                                        ...
                                                        <textarea rows="3" name="answers[{{ $question->id }}]" class="form-control mb-4" placeholder="enter your answer"
                                                            rows="6"></textarea>
                                                    @endforeach
                                                </div>
                                                <hr>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 order-lg-2 order-1">
                    <div class="sidebar-right py-4 px-3">
                        ...
                        <a class="company-jobs-link" href="{{route('employer.profile', optional($job->employer_profile)->employer_id)}}">View Company Profile</a>
                        @endif
                    </div>
                </div>
            </div>
