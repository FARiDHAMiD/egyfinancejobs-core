					...
					<tbody>
						<tr>
							<td align="center" valign="top">
								<table border="0" cellpadding="0" cellspacing="0" width="100%"
									...
									<tbody>
										<tr>
											<td style="background-color:#FF7900;font-size:1px;line-height:3px"
												height="3">&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											<td style="text-align: center;">
												<img src="{{asset('website/img/logo.png')}}" border="0"
													style="width:100%;max-width: 150px;height:auto;color:#f9f9f9;"
													width="600">
											</td>
							</td>
						</tr>
						...
						<tr>
							<td style="padding-bottom:30px;padding-left:20px;padding-right:20px" align="center"
								valign="top">
								<h4
									style="color:#FF7900;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;text-align:center;padding:0;margin:0">
									We are very glade to announce you as Instructor in Egy Finance Courses Team.</h4>
								<h5
									...
									Waitning your exciting journy, and wish you a very good luck!</h5>
							</td>
						</tr>
						<tr>
										...
										<tr>
											<td style="padding-bottom:20px" align="center" valign="top">
												<p
													...
													Thanks for subscriping Egy Finance Jobs.</p>
											</td>
										</tr>
									</tbody>
								</table>
										...
										<tr>
											<td style="padding-top:20px;padding-bottom:20px" align="center"
												...
												<table border="0" cellpadding="0" cellspacing="0" align="center">
													<tbody>
														<tr>
															<td style="background-color:#FF7900;padding:12px 35px;border-radius:50px"
																align="center"> <a {{--
																	href="{{route('employee.profile.view'.$user->remember_token)}}"
																	--}} href="https://egyfinancejobs.com/courses"
