...
<div class="container-fluid">
    <!-- Course Create Form -->
    <form enctype="multipart/form-data" class="form" method="POST" action="{{route('courses.store')}}">
        @csrf
        <div class="row">
            {{-- Create New Course --}}
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select type="text" name="cat_id"
                                    ...
                                    @foreach ($cats as $cat)
                                    <option {{ old('cat_id')==$cat->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select type="text" name="instructor_id"
                                    ...
                                    <option {{ old('instructor_id')==$instructors->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <textarea name="info" class="form-control @error('info') is-invalid @enderror "
                                    cols="30" rows="3">{{old('info')}}</textarea>
                                @error('info')
                                <span role="alert" class="invalid-feedback">( {{ $message }} )</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <select type="text" name="statu_id"
                                    ...
                                    <option {{ old('statu_id')==$statu->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="prerequisite"
                                    ...
                                    rows="2">{{old('prerequisiter')}}</textarea>
                                @error('prerequisite')
                                <span role="alert" class="invalid-feedback">( {{ $message }} )</span>
                                @enderror
                            </div>
