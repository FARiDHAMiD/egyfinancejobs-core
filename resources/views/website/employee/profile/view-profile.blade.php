                    ...
                    <div class="work-experience-box bg-grea-3">
                        <div class="description w-100">
                            <div class="row align-items-center">
                                ...
                                <p class="text-sm text-dark-light m-0">{{ $profile->job_title->name }} | {{ $profile->career_level->name }}</p>
                                    <p class="text-sm text-dark-light m-0 text-gray">{{ empty($profile->area) ? null : $profile->area->name }},
                                        {{ empty($profile->city) ? null : $profile->city->name }}, {{ $profile->country->name }}</p>
                                        <p class="text-sm text-dark-light m-0">{{ optional($employee_achievements)->description }}</p>

                                </div>
                            </div>
                        </div>
                        @if (auth()->check() && auth()->user()->hasRole('employee'))
                            <a href="{{ route('employee.profile.general-info.edit') }}"><button
                                    class="edit-btn bg-grea-3"><i class="fa fa-pencil-square-o"></i></button></a>
                        @endif
                    </div>
                    <div class="job-box">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <p class="text-black mb-0 text-sm">
                                                @if ((auth()->check() && (auth()->user()->hasRole('admin') || auth()->user()->hasRole('employee'))) || $profile->show_salary == 1)
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <p class="mb-0"><strong class="text-black text-sm">Job Categories</strong></p>
                                                <p>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <p class="mb-0"><strong class="text-black text-sm">Online Presence:</strong></p>
                                                <div class="employer-links justify-content-center">
                                                    <ul class="social-media">
                                                        @if($employee_social_links->facebook)<li>
                                                            <a class="facebook-bg" href="{{$employee_social_links->facebook}}" target="_blank" ><i class="fa fa-facebook"></i></a></li>
                                                        @endif
                                                        @if($employee_social_links->linkedin)<li>
                                                            <a class="linkedin-bg" href="{{$employee_social_links->linkedin}}" target="_blank" ><i class="fa fa-linkedin"></i></a></li>
                                                        @endif
                                                        @if($employee_social_links->youtube)<li>
                                                            <a class="youtube-bg" style="background-color:    #f00;" href="{{$employee_social_links->youtube}}" target="_blank" ><i class="fa fa-youtube"></i></a></li>
                                                        @endif
                                                        @if($employee_social_links->website)<li>
                                                            <a class="website-bg" style="background-color:    #1c4ea7;" href="{{$employee_social_links->website}}" target="_blank" ><i class="fa fa-sitemap" aria-hidden="true"></i></a></li>
                                                        @endif
                                                        @if($employee_social_links->other)<li>
                                                            <a class="other-bg" href="{{$employee_social_links->other}}" target="_blank" ><i class="fa fa-cubes" aria-hidden="true"></i></a></li>
                                                        @endif
                                ...
                                <div class="work-experience-box">
                                    <div class="description">
                                        ...
                                        @if($education->getFirstMedia('education_certificate'))
                                            <p><strong>Certificate:</strong> <span>{{$education->certificate_title}}</span> | <a target="_blank" href="{{$education->getFirstMedia('education_certificate')->getUrl()}}">view <i class="fa fa-eye"></i></a> </p>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
                                ...
                                @foreach ($employee->getMedia('employee_certificates') as $item)
                                    <div class="up-files mt-4">
                                        <div class="file-input mb-3"
                                            ...
                                            <a target="_blank" href="{{ $item->getFullUrl() }}"
                ...
                <div class="col-lg-3 col-md-12 order-lg-2 order-1">
                        ...
                        <div class="employer-links justify-content-center">
                            <ul class="social-media">
                                <li>
                                    <a 
                                        class="facebook-bg"
                                        href="https://www.facebook.com/sharer/sharer.php?u={{ route('employee.profile.view', $employee->id) }}" 
                                        target="_blank"
                                    >
                                ...
                                <li>
                                    <a 
                                        class="linkedin-bg"
                                        href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('employee.profile.view', $employee->id) }}&title={{ $employee->first_name . ' ' . $employee->last_name }}&summary={{ $profile->job_title->name }} | {{ $profile->career_level->name }}&source={{ route('website.home') }}" 
                                        target="_blank" 
                                ...
                                <li>
                                    <a 
                                        class="twitter-bg" 
                                        target="_blank" 
                                        href="https://x.com/intent/tweet?text={{ $employee->first_name . ' ' . $employee->last_name }}&url={{ route('employee.profile.view', $employee->id) }}" >
                                        <i class="fa fa-twitter"></i>
                                    </a>
                                </li>
                                
                                <li><a class="copy-bg copyLink" href="{{ route('employee.profile.view', $employee->id) }}" ><i class="fa fa-copy"></i></a>
                    ...
                    @if ($employee->getFirstMedia('employee_cv'))
                        <div class="sidebar-right py-4 px-3 text-center">
                            ...
                            <a href="{{$employee->getFirstMedia('employee_cv')->getUrl()}}" target="_blank" ><button class="btn button-theme mb-md-0 mb-3" type="submit">View <i class="fa fa-eye"></i></button></a>
                        </div>
                    @endif
