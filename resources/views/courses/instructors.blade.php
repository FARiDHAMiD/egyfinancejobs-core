    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-teacher">
                    <div class="teacher-head overlay">
                        <img src="{{asset('courses_template/images/teachers/teacher-1.jpg')}}" alt="#">
                        <ul class="social">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-teacher">
                    <div class="teacher-head overlay">
                        <img src="{{asset('courses_template/images/teachers/teacher-5.jpg')}}" alt="#">
                        <ul class="social">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-teacher">
                    <div class="teacher-head overlay">
                        <img src="{{asset('courses_template/images/teachers/teacher-3.jpg')}}" alt="#">
                        <ul class="social">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-teacher">
                    <div class="teacher-head overlay">
                        <img src="{{asset('courses_template/images/teachers/teacher-4.jpg')}}" alt="#">
                        <ul class="social">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-teacher">
                    <div class="teacher-head overlay">
                        <img src="{{asset('courses_template/images/teachers/teacher-2.jpg')}}" alt="#">
                        <ul class="social">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
