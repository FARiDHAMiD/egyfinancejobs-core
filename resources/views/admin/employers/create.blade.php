                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select type="text" name="company_size" class="form-control @error('company_size') is-invalid @enderror "> 
                                    ...
                                    <option {{ old('company_size') == '11-100' ? 'selected' : '' }} value="11-100">11-100</option>
                                    <option {{ old('company_size') == '101-1000' ? 'selected' : '' }} value="101-1000">101-1000</option>
                                    <option {{ old('company_size') == '1000+' ? 'selected' : '' }} value="1000+">1000+</option>
                                </select>
                                @error('company_size')
                                    <span role="alert" class="invalid-feedback">( {{ $message }} )</span>
                                @enderror
                            ...
                            <div class="mb-3"> 
                                ...
                                <select type="text" name="company_industry" class="form-control @error('company_industry') is-invalid @enderror "> 
                                    ...
                                    @foreach ($industries as $industry)
                                        <option {{ old('company_industry') == $industry->id ? 'selected' : '' }} value="{{$industry->id}}">{{$industry->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12">
                            <div class="mb-3"> 
                                ...
                                <textarea type="text" name="company_description" class="form-control @error('company_description') is-invalid @enderror ">{{old('company_description')}}</textarea>
                        ...
                        <div class="col-12">  
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-auto text-center">
                                    ...
                                    <div class="upload-image-box">
                                        <div class="user-image-circle">
                                            <img height="200px" class="image" src="{{ asset('/website/img/banner_img.jpg') }}" alt="">
                                        </div>
                                        <div class="mt-4">
